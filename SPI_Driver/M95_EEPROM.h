...
typedef struct{
	...
	uint16_t			CSPin;			/*GPIO Pin for Device Chip Select Pin*/
...
extern M95_status_t M95_Clear(SPI_HandleTypeDef *hspi, EEPROM_Config_t *pEEPROM);
extern M95_status_t M95_Wait_Until_WIP(SPI_HandleTypeDef *hspi, EEPROM_Config_t *pEEPROM, uint32_t Timeout);
#endif /* M95_EEPROM_H_ */
